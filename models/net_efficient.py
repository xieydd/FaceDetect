...
class EfficientDet(nn.Module):
    ...
    def multibox(self, num_classes):
        ...
        if self.fpn_flag:
            ...
            '''
            loc_layers  += [nn.Conv2d(56, anchor_num[0] * 4, kernel_size=3, padding=1)]
            conf_layers += [nn.Conv2d(56, anchor_num[0] * num_classes, kernel_size=3, padding=1)]
            landm_layers += [nn.Conv2d(56, anchor_num[0] * 10, kernel_size=3, padding=1)]
            ...
            landm_layers += [nn.Conv2d(112, anchor_num[1] * 10, kernel_size=3, padding=1)]
            ...
            landm_layers += [nn.Conv2d(160, anchor_num[2] * 10, kernel_size=3, padding=1)]
 
 
            loc_layers  += [nn.Conv2d(272, anchor_num[3] * 4, kernel_size=3, padding=1)]
            conf_layers += [nn.Conv2d(272, anchor_num[3] * num_classes, kernel_size=3, padding=1)]
            landm_layers += [nn.Conv2d(272, anchor_num[3]  * 10, kernel_size=3, padding=1)]
            '''
