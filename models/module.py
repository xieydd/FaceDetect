...
class Backbone_(nn.Module):
    def __init__(self, bn=True):
        ...
        self.conv1_1 = BasicConv(3,  16, kernel_size=3, stride=2, padding=1, bn=bn)
        self.conv1_2 = BasicConv(16,  32, kernel_size=3, padding=1, bn=bn)
        self.conv1_3 = BasicConv(32, 32, kernel_size=3, stride=2, padding=1, bn=bn)
        #self.pool1 = nn.MaxPool2d(kernel_size=2, stride=2)  # 2
 
        self.conv2_1 = BasicConv(32, 32, kernel_size=3, padding=1, bn=bn)
        self.conv2_2 = BasicConv(32, 64, kernel_size=3, stride=2, padding=1, bn=bn)
        #self.pool2 = nn.MaxPool2d(kernel_size=2, stride=2) # 4
 
        self.conv3_1 = BasicConv(64, 64, kernel_size=3, padding=1, bn=bn)
        self.conv3_2 = BasicConv(64, 64, kernel_size=3, padding=1, bn=bn)
        #self.pool3 = nn.MaxPool2d(kernel_size=2, stride=2, ceil_mode=bn)  # 8
 
        #self.conv4_1 = BasicConv(128, 128, kernel_size=1, bn=bn)
        #self.conv4_2 = BasicConv(128, 128, kernel_size=3, padding=1, bn=bn)         #### f1 ####
        self.conv4_1 = BasicRFB(64, 64, stride = 1, scale=1.0)
        #self.pool4 = nn.MaxPool2d(kernel_size=2, stride=2)  # 16
 
        self.conv5_1 = BasicConv(64, 128, kernel_size=3, stride=2, padding=1, bn=bn)
        self.conv5_2 = BasicConv(128, 128, kernel_size=3, padding=1, stride=1, bn=bn) #### f2 ####
 
        self.conv6_1 = BasicConv(128, 256, kernel_size=3, stride=2, padding=1, bn=bn)
        self.conv6_2 = BasicConv(256, 256, kernel_size=3, padding=1, bn=bn) #### f3 ####
 
        self.conv7_1 = BasicConv(256, 64, kernel_size=1, relu=True, bn=False)
        self.conv7_2 = BasicConv(64, 256, kernel_size=3, padding=1, stride=2, relu=True, bn=False) #### f4 ####
...
class Backbone3(nn.Module):
    def __init__(self, bn=True):
        ...
        self.conv1_1 = BasicConv(3,  32, kernel_size=3, padding=1, bn=bn)
        self.conv1_2 = BasicConv(32, 32, kernel_size=3,stride=2, padding=1, bn=bn)
        #self.pool1 = nn.MaxPool2d(kernel_size=2, stride=2)  # 2
 
        self.conv2_1 = BasicConv(32, 64, kernel_size=3, padding=1, bn=bn)
        self.conv2_2 = BasicConv(64, 64, kernel_size=3, stride=2, padding=1, bn=bn)
        #self.pool2 = nn.MaxPool2d(kernel_size=2, stride=2) # 4
 
        self.conv3_1 = BasicConv(64, 128, kernel_size=1, bn=bn)
        self.conv3_2 = BasicConv(128, 128, kernel_size=3, stride=2, padding=1, bn=bn)
        #self.pool3 = nn.MaxPool2d(kernel_size=2, stride=2, ceil_mode=bn)  # 8
        ...
        self.conv5_1 = BasicConv(256, 128, kernel_size=1, stride=2, relu=False, bn=bn)
        self.conv5_2 = BasicConv(128, 256, kernel_size=3, padding=1, stride=1, bn=bn) #### f2 ####
