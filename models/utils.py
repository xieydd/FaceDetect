'''
@Author: your name
@Date: 2020-06-04 21:42:19
@LastEditTime: 2020-06-06 19:05:14
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: /FaceDetect/models/utils.py
'''
"""
...
def load_pretrained_weights(model, model_name, load_fc=True, advprop=False):
    ...
    state_dict = torch.load('/Workspace/deeplearning/FaceDetect/weights/efficientnet-b3-cdd7c0f4.pth')
    if load_fc:
